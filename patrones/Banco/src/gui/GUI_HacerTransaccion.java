...
public class GUI_HacerTransaccion extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        GUI_MenuCliente menClient = new GUI_MenuCliente();
        menClient.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_HacerTransaccion().setVisible(true);
            }
        });
    }
